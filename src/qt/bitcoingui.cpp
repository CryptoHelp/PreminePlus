...
//      setStyleSheet("font: 9pt Lucida Grande;");
        setStyleSheet("* {font-family: Impact;color:white;} BitcoinGUI { background: url(:/images/bg);}");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a PreminePlus address"));
...
// ADDED CHAT TO MENU
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About PreminePlus"), this);
    aboutAction->setToolTip(tr("Show information about PreminePlus"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for PreminePlus"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    appMenuBar->setStyleSheet("QMenu {border:1px solid white;} QMenuBar::item { background-color:rgba(0,0,0,0);color:white;} QMenu::item::selected {background-color: #2a82da;} QMenuBar {background-color:rgba(0,0,0,0);} * {background-color:black;font-size:9pt;} QMenuBar::item::selected {background-color: #2a82da;}");
}
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("Qtoolbar {margin-top:20px;} QWidget {width:120px;color:white;float:left;font:10pt Impact;font-weight:normal;}");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("PreminePlus client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("PreminePlus client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PreminePlus network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid PreminePlus address or malformed URI parameters."));
    }
