...
unsigned int nStakeMinAge = 60 * 60;	// minimum age for coin age: 1 hour
unsigned int nStakeMaxAge = 60 * 60 * 8;	// stake age of full weight: 8h
unsigned int nStakeTargetSpacing = 20;			// 20 sec block spacing

int64 nChainStartTime = 1402323781;
...
const string strMessageMagic = "PreminePlus Signed Message:\n";
...
// const int YEARLY_BLOCKCOUNT = 1576800;	// 365 * 4320
...
static const int64 nTargetTimespan = 60 * 10;  // 20 blocks
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in PreminePlus
    bool fStrictPayToScriptHash = true; // Always active in PreminePlus
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PreminePlus", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Premine Plus";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1402323791;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 5141730;
        ...
        assert(block.hashMerkleRoot == uint256("0xed23795776759dd3bcdf46b16c3e81b4824124f13c3f9f62698c2bac6723b6c5"));
...
//ADDED MINTING MESSAGE
    if (strMintWarning == "")
    {
        strStatusBar = "Info: Currently minting one or more stake amounts.";
    }
